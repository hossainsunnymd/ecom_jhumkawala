...
<template>
    ...
    <main class="pt-90" style="padding-top: 0px">
        <CustomerLayout>
            <template #header
                ><h2 class="page-title">Order Details</h2></template
            >
                        ...
                        >
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        {{
                                            page.props.order.order_address
                                                .pincode
                                        }}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        {{ page.props.order.delivery_date }}
                                    </td>
                                    <th>Canceled Date</th>
                                    <td>{{ page.props.order.cancel_date }}</td>
                                </tr>
                                <tr>
                                    <th>Order Status</th>
                                    <td colspan="5">
                                        <span class="">{{
                                            page.props.order.order_status
                                        }}</span>
                                    </td>
                                </tr>
                            </tbody>
                ...
                <div class="wg-box wg-table table-all-user">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <tr
                                    v-for="item in page.props.order.order_items"
                                    :key="item.id"
                                >
                                    <td class="pname">
                                        <div class="image">
                ...
                <div class="wg-box mt-5">
                    ...
                    <div class="my-account__address-item col-md-6">
                        <div class="my-account__address-item__detail">
                            ...
                            <p>
                                Mobile :
                                {{ page.props.order.order_address.phone }}
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        >
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="">{{
                                            page.props.order.payment_status
                                        }}</span>
                                    </td>
                                </tr>
                            </tbody>
