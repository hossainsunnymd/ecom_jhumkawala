            ...
            <div class="shopping-cart">
                <div class="cart-table__wrapper">
                    <table class="cart-table">
                        ...
                        <tbody>
                            <tr v-for="cart in page.props.cartList">
                                <td>
                                ...
                                <td>
                                    <Link :href="`/customer/cart/remove/${cart.product.id}`" class="remove-cart">
                                        <svg
                                            width="10"
                                            height="10"
                                            viewBox="0 0 10 10"
                        ...
                        <div class="shopping-cart__totals">
                            ...
                            <table class="cart-totals">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Discount</th>
                                        <td>{{ page.props.cartDiscount }}</td>
                                    </tr>
                                    <tr>
                                        <th>Total</th>
                                        <td>{{ page.props.cartTotal - page.props.cartDiscount }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
