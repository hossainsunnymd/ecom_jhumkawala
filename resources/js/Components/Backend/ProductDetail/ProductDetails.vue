...
function deleteProductDetail(id) {
    if (confirm("Are you sure you want to delete this Product Detail?")) {
        router.get(`/admin/products/${id}/details`);
    }
}
            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <Link
                        ...
                        :href="`/admin/products/details/save?id=${0}`"
                ...
                <div class="wg-table table-all-user">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <tr
                                    v-for="(productDetail, index) in page.props
                                        .productDetails"
                                    :key="index"
                                >
                                    <td>{{ index + 1 }}</td>
                                    <td>{{ productDetail.product.name }}</td>
                                    <td v-html="productDetail.description"></td>
                                    <td>
                                        <img
                                    ...
                                    <td>
                                        <div class="list-icon-function">
                                            <Link
                                                :href="`/admin/products/details/save?id=${productDetail.id}`"
                                            >
                                                <div class="item edit">
