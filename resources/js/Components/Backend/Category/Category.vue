        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <Link class="tf-button style-1 w208" :href="`/admin/category/save?id=${0}`"
                        ><i class="icon-plus"></i>
                        Add new</Link >
                </div>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <tr v-for="(category,index) in page.props.categories" :key="index">
                                    ...
                                    <td>{{ category.name }}</td>
                                    <td>
                                        <Link :href="`/shop/category/${category.slug}`" target="_blank">{{ category.slug }}</Link>
                                    </td>
                                    <td>
                                        <div class="list-icon-function">
                                            <Link :href="`/admin/category/save?id=${category.id}`">
                                                <div class="item edit">
